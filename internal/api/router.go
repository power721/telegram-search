...
func NewRouter(deps Dependencies) *gin.Engine {
	...
	adminOnly.GET("/search/global", h.searchGlobal)
	adminOnly.GET("/search/messages", h.searchMessages)
	adminOnly.GET("/search/links", h.searchLinks)
	adminOnly.GET("/search/files", h.searchFiles)
	adminOnly.GET("/search/channels", h.searchChannels)
	adminOnly.GET("/search", h.search)
	adminOnly.POST("/search/remote", h.createRemoteSearchTask)
	adminOnly.GET("/search/remote/:task_id", h.getRemoteSearchTask)
